...
class AmazonProductScraper:
    ...
    def get_category_url(self, cat):

        self.category_name = cat  # input(
    ...
    def extract_product_information(page_results):
        ...
        for i in range(len(page_results)):
            ...
            try:
                ...
                product_price = product_price_location.find(
            ...
            product_information = (
                description, product_price[1:], product_review, review_number, category_url)
    ...
    def navigate_to_other_pages(self, category_url):
        ...
        try:
            ...
            number_of_pages = self.driver.find_element_by_xpath(
                max_number_of_pages)
        ...
        for i in range(2, 3):  # int(number_of_pages.text) + 1):
            # Goes to next page
    ...
    def product_information_spreadsheet(self, records):
        ...
        # for _ in records:
        #    file_name = "file1.csv".format(self.category_name, today)
...
def work(search):
    ...
    category_details = my_amazon_bot.get_category_url(search)

    my_amazon_bot.extract_product_information(
        my_amazon_bot.extract_webpage_information())
